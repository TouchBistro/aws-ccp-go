...
// AWS service.
//
// The Client() is a wrapper on appconfigdata.NewFromConfig(), which creates & caches
// the client.
//
...
// Client builds or returns the singleton appconfigdata client for the supplied provider
