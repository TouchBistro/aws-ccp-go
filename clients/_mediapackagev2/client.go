...
// AWS service.
//
// The Client() is a wrapper on mediapackagev2.NewFromConfig(), which creates & caches
// the client.
//
...
// Client builds or returns the singleton mediapackagev2 client for the supplied provider
// If functional options are supplied, they are passed as-is to the underlying NewFromConfig(...)
// for the corresponding client
func Client(provider providers.CredsProvider, optFns ...func(*mediapackagev2.Options)) (*mediapackagev2.Client, error) {
