...
// GENERATED ON 2024-06-25 08:17:35

// Package _xray provides AWS client management functions for the xray
// AWS service.
//
// The Client() is a wrapper on xray.NewFromConfig(), which creates & caches
// the client.
//
...
// Client builds or returns the singleton xray client for the supplied provider
// If functional options are supplied, they are passed as-is to the underlying NewFromConfig(...)
// for the corresponding client
func Client(provider providers.CredsProvider, optFns ...func(*xray.Options)) (*xray.Client, error) {
