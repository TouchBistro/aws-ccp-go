...
// AWS service.
//
// The Client() is a wrapper on apigatewaymanagementapi.NewFromConfig(), which creates & caches
// the client.
//
...
// Client builds or returns the singleton apigatewaymanagementapi client for the supplied provider
// If functional options are supplied, they are passed as-is to the underlying NewFromConfig(...)
// for the corresponding client
func Client(provider providers.CredsProvider, optFns ...func(*apigatewaymanagementapi.Options)) (*apigatewaymanagementapi.Client, error) {
