...
// AWS service.
//
// The Client() is a wrapper on sts.NewFromConfig(), which creates & caches
// the client.
//
...
// Client builds or returns the singleton sts client for the supplied provider
// If functional options are supplied, they are passed as-is to the underlying NewFromConfig(...)
// for the corresponding client
func Client(provider providers.CredsProvider, optFns ...func(*sts.Options)) (*sts.Client, error) {
