...
// AWS service.
//
// The Client() is a wrapper on applicationdiscoveryservice.NewFromConfig(), which creates & caches
// the client.
//
...
// Client builds or returns the singleton applicationdiscoveryservice client for the supplied provider
// If functional options are supplied, they are passed as-is to the underlying NewFromConfig(...)
// for the corresponding client
func Client(provider providers.CredsProvider, optFns ...func(*applicationdiscoveryservice.Options)) (*applicationdiscoveryservice.Client, error) {
